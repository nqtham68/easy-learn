...
source_url: https://docs.nats.io/running-a-nats-service/configuration/securing_nats/jwt/jwt_nkey_auth
title: Thiết Lập Xác Thực/Phân Quyền Hỗn Hợp
translated: true
translated_at: '2026-05-17T00:00:00Z'
---

# Thiết Lập Xác Thực/Phân Quyền Hỗn Hợp
...
Có thể kết hợp cả cấu hình static nkeys với JWT Authentication/Authorization phi tập trung, nhưng cần chuẩn bị trước một số bước.
...
Cách thực hiện là: **đầu tiên** tạo một operator setup tin cậy cơ bản có thể dùng về sau, rồi dựa trên cấu hình đó để tạo NKEYS static config — dùng chung public nkeys cho các account. Sau đó, dùng clustering routes để kết nối hai cơ chế xác thực khác nhau trong quá trình chuyển đổi. Cluster (cụm nhiều server chạy chung) đóng vai trò cầu nối giữa hai mô hình này.

> 🇬🇧 *For example, creating the following initial setup using [NSC](../../../../using-nats/nats-tools/nsc):*

Ví dụ, tạo setup ban đầu bằng [NSC](../../../../using-nats/nats-tools/nsc):
...
Kết quả sẽ tạo ra output tương tự như sau:
