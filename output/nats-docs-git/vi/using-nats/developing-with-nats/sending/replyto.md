...
source_url: https://docs.nats.io/using-nats/developing-with-nats/sending/replyto
title: Đính kèm Reply Subject
translated: true
translated_at: '2026-05-17T00:00:00Z'
---

# Đính kèm Reply Subject
...
Trường reply-to tùy chọn khi publish message cho phép bên nhận biết nơi cần phản hồi về. Reply-to subject (chuỗi định danh message) thường được gọi là _inbox_, và hầu hết các thư viện đều cung cấp method tạo inbox subject duy nhất. Hầu hết thư viện cũng hỗ trợ pattern request (yêu cầu)-reply chỉ bằng một lần gọi. Ví dụ, để gửi request tới subject `time` với nội dung rỗng, publisher (bên gửi message) có thể dùng như sau:
