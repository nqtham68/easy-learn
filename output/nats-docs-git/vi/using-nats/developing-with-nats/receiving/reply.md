...
source_url: https://docs.nats.io/using-nats/developing-with-nats/receiving/reply
title: Phản hồi một Message
translated: true
translated_at: '2026-05-17T00:00:00+00:00'
---

# Phản hồi một Message
...
Mỗi message (gói dữ liệu được gửi đi) đến có thể kèm theo trường `reply-to` tùy chọn. Nếu trường này được đặt, nó sẽ chứa một subject (chuỗi định danh message) mà phía gửi mong nhận được phản hồi tại đó.

> 🇬🇧 *For example, the following code will listen for that request and respond with the time.*

Ví dụ dưới đây minh họa cách lắng nghe request (yêu cầu) và gửi lại response (phản hồi) chứa thời gian hiện tại.
