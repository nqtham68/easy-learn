...
source_url: https://docs.nats.io/using-nats/developing-with-nats/receiving/unsubscribing
title: Hủy đăng ký nhận message
translated: true
translated_at: '2026-05-17T00:00:00+00:00'
---

# Hủy đăng ký nhận message

> 🇬🇧 *The client libraries provide a means to unsubscribe a previous subscription request.*

Các thư viện client cung cấp cơ chế để hủy một subscription (đăng ký nhận message) đã thiết lập trước đó.
...
Quá trình này cần tương tác với server, vì vậy với một async subscription (đăng ký bất đồng bộ), có thể có một khoảng thời gian ngắn mà message vẫn đến trong lúc thư viện đang xử lý lệnh hủy. Bỏ qua edge case nhỏ đó, thư viện client sẽ dọn sạch các message còn tồn đọng và thông báo với server rằng subscription đó không còn được sử dụng nữa.
