...
source_url: https://docs.nats.io/using-nats/developing-with-nats/receiving/unsub_after
title: Hủy Đăng Ký Sau N Message
translated: true
translated_at: '2026-05-17T00:00:00+00:00'
---

# Hủy Đăng Ký Sau N Message
...
NATS cung cấp một dạng hủy đăng ký đặc biệt: cấu hình theo số lượng message (gói dữ liệu được gửi đi), và có hiệu lực khi subscriber (bên đăng ký nhận message) nhận đủ số lượng đó. Cơ chế này rất hữu ích khi chỉ cần nhận đúng một message.
...
Số lượng message được tính theo tổng cộng dồn của subscriber. Ví dụ, nếu đặt count là 1, server sẽ ngừng gửi message đến subscription đó ngay sau khi nó nhận được 1 message. Nếu subscriber đã nhận được một hoặc nhiều message từ trước, việc hủy đăng ký diễn ra ngay lập tức. Hành vi dựa trên lịch sử này có thể gây nhầm lẫn khi áp dụng auto-unsubscribe cho một subscription tồn tại lâu, nhưng lại hoàn toàn hợp lý với subscription mới.
...
Auto-unsubscribe tính dựa trên tổng số message đã gửi đến subscriber, không chỉ những message mới. Hầu hết các client library đều theo dõi số message tối đa sau khi có yêu cầu auto-unsubscribe. Khi reconnect, điều này cho phép client gửi lại lệnh hủy đăng ký với tổng số đã được cập nhật.

> 🇬🇧 *The following example shows unsubscribe after a single message:*

Ví dụ sau minh họa cách hủy đăng ký sau khi nhận một message:
